...
In this paper, we aim to learn more about how learners engage with in-video quizzes, and what effects quizzes have on their engagement with the rest of the video. We do this by analyzing the video-viewing logs of the Machine Learning course on Coursera (ML4). We discovered the following engagement patterns associated with in-video quizzes:
...
If we look at lectures 25-30 in \autoref{fig:forward-seek-destinations-allvideos}, they don't visually match the pattern we see in the other lectures. This is because they're optional videos discussing applications of Machine Learning, which don't have in-video quizzes. % or required material.
...
Our results suggest future work investigating the effects of in-video quizzes on in-video engagement rates. Previous work (on videos lacking in-video quizzes) has shown that there is a steady dropoff in users watching lectures, particularly in longer lecture videos \cite{juho}. However, as we saw in \autoref{fig:lec13-multiplot} E, the dropoff in number of views appears to temporarily stop in the area surrounding the in-video quizzes. Additionally, because users tend to   in-video quizzes appear to segment the videos into smaller subsections that users tend to skip within, but do not skip between, as shown in \autoref{fig:scatter-plot-of-seeks} This suggests that in-video quizzes may potentially counteract the disengagement patterns that occur in longer lecture videos. However, A/B tests would be required to actually verify the effects of .
