...
\item Users do not tend to skip over in-video quizzes, either in the forward or backward direction. They thus segment the video into smaller subunits that users do not skip between.
\end{compactitem}

These behaviors suggest that viewers consider in-video quizzes to be a priority and frequently refer to them. They also suggest that video-viewing interfaces should perhaps make it easier for users to refer back to in-video quizzes while viewing and reviewing videos. % between in-video quizzes and the preceding segment where the answers can be found.
