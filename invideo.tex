...
These behaviors suggest that viewers consider in-video quizzes to be a priority and frequently refer to them. It also suggests that video-viewing interfaces should perhaps make it easier for users to navigate between in-video quizzes and the preceding segment where the answers can be found.
